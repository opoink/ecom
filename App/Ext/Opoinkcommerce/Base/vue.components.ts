...
/**** Home ****/
Vue.component('vue-home', function (resolve, reject) {
...
/**** DefaultHeader ****/
Vue.component('vue-defaultheader', function (resolve, reject) {
...
/**** DefaultFooter ****/
Vue.component('vue-defaultfooter', function (resolve, reject) {
...
/**** AdminHome ****/
Vue.component('vue-adminhome', function (resolve, reject) {
...
/**** AdminSideMenu ****/
Vue.component('vue-adminsidemenu', function (resolve, reject) {
...
/**** AdminMainHeader ****/
Vue.component('vue-adminmainheader', function (resolve, reject) {
